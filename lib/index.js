(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("popper.js"), require("react"), require("react-onclickoutside"), require("prop-types"));
	else if(typeof define === 'function' && define.amd)
		define(["popper.js", "react", "react-onclickoutside", "prop-types"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("popper.js"), require("react"), require("react-onclickoutside"), require("prop-types")) : factory(root["popper.js"], root["react"], root["react-onclickoutside"], root["prop-types"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_17__, __WEBPACK_EXTERNAL_MODULE_4__) {
...
var TextInput = function (_Component4) {
  ...
  function TextInput() {
    ...
    return _ret3 = (_temp3 = (_this6 = _possibleConstructorReturn(this, (_ref4 = TextInput.__proto__ || Object.getPrototypeOf(TextInput)).call.apply(_ref4, [this].concat(args))), _this6), _this6.state = {
      lastKey: undefined,
      isHoldingSameKey: false // Used to throttle back space.
    }, _this6.onChange = function (event) {
      _this6.props.onChange(event.target.value);
      _this6.attemptMention(event.target);
    }, _this6.onScroll = function (event) {
      _this6.props.onScroll({
        scrollLeft: event.target.scrollLeft,
        scrollTop: event.target.scrollTop
      });
    }, _this6.getCoordinates = function () {
      var _getCoordinates = (0, _getCoordinates3.default)(_this6.textarea, _this6.textarea.selectionEnd),
          left = _getCoordinates.left,
          top = _getCoordinates.top;

      var nextTop = top;

      if (_this6.textarea.scrollHeight > _this6.textarea.clientHeight) {
        nextTop = top - (_this6.textarea.scrollHeight - _this6.textarea.clientHeight);
      }
      ...
      _this6.setState({
        ...
        isHoldingSameKey: _this6.state.lastKey === event.keyCode
      });

      _this6.props.onKeyDown(event);
    }, _this6.onKeyUp = function (event) {
      var isHoldingSameKey = _this6.state.isHoldingSameKey;
      event.persist();
      _this6.setState({
        lastKey: undefined,
  ...
  _createClass(TextInput, [{
    key: 'attemptMention',
    value: function attemptMention(target) {
      var mentioned = this.getLastWord(target);

      var isMatched = new RegExp('(' + this.props.trigger + '\\w+)', 'g').test(mentioned);

      if (mentioned && mentioned.length > 1 && isMatched && this.state.isHoldingSameKey === false) {
...
var TextArea = function (_Component5) {
  ...
  function TextArea() {
    ...
    }, _this8.onKeyUp = function () {
      return _this8.updateCoordinates();
  ...
  _createClass(TextArea, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.state.isActivated && this.props.suggestions.length > 0 && _react2.default.createElement(_Suggestions2.default, {
...
TextArea.propTypes = {
  ...
  trigger: _propTypes2.default.oneOf(['@', '#']),
  placeholder: _propTypes2.default.string,
  scrollParent: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.object])
};
    ...
    options.map(function (item, index) {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          item.avatar && _react2.default.createElement('img', { src: item.avatar, alt: item.label }),
          _react2.default.createElement(
            'span',
            null,
            item.label
